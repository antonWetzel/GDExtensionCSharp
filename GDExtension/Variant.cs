...
public unsafe class Variant {
	...
	public static void InteropSaveIntoPointer(String value, IntPtr _internal_pointer) => gdInterface.get_variant_from_type_constructor.Call(VariantType.String)(_internal_pointer, new IntPtr(&value));

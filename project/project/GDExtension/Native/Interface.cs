...
//not a real type alias
using Bool = System.Boolean;
using Int = System.Int64;
using ObjectInstanceID = System.UInt64;
...
public unsafe struct VariantPtr {
	public void* ptr;
	public static implicit operator void*(VariantPtr ptr) => ptr.ptr;
	public static implicit operator VariantPtr(void* ptr) => new VariantPtr() { ptr = ptr };
}
public unsafe struct StringNamePtr {
	void* ptr;
	public static implicit operator void*(StringNamePtr ptr) => ptr.ptr;
	public static implicit operator StringNamePtr(void* ptr) => new StringNamePtr() { ptr = ptr };
}
public unsafe struct StringPtr {
	void* ptr;
	public static implicit operator void*(StringPtr ptr) => ptr.ptr;
	public static implicit operator StringPtr(void* ptr) => new StringPtr() { ptr = ptr };
}
public unsafe struct ObjectPtr {
	void* ptr;
	public static implicit operator void*(ObjectPtr ptr) => ptr.ptr;
	public static implicit operator ObjectPtr(void* ptr) => new ObjectPtr() { ptr = ptr };
}
public unsafe struct TypePtr {
	void* ptr;
	public static implicit operator void*(TypePtr ptr) => ptr.ptr;
	public static implicit operator TypePtr(void* ptr) => new TypePtr() { ptr = ptr };
}
public unsafe struct ExtensionPtr {
	void* ptr;
	public static implicit operator void*(ExtensionPtr ptr) => ptr.ptr;
	public static implicit operator ExtensionPtr(void* ptr) => new ExtensionPtr() { ptr = ptr };
}
public unsafe struct MethodBindPtr {
	void* ptr;
	public static implicit operator void*(MethodBindPtr ptr) => ptr.ptr;
	public static implicit operator MethodBindPtr(void* ptr) => new MethodBindPtr() { ptr = ptr };
}
...
public unsafe struct InstanceBindingCallbacks {
	...
	public delegate* unmanaged[Cdecl]<void*, void*, bool, bool> reference_callback;
}

/* EXTENSION CLASSES */

public unsafe struct ExtensionClassInstancePtr {
	void* ptr;
	public static implicit operator void*(ExtensionClassInstancePtr ptr) => ptr.ptr;
	public static implicit operator ExtensionClassInstancePtr(void* ptr) => new ExtensionClassInstancePtr() { ptr = ptr };
}
...
public unsafe struct ExtensionClassCreationInfo {
	...
	public delegate* unmanaged[Cdecl]<ExtensionClassInstancePtr, StringPtr, void> to_string_func;
	...
	public delegate* unmanaged[Cdecl]<void*, ObjectPtr> create_instance_func; /* this one is mandatory */
	public delegate* unmanaged[Cdecl]<void*, ExtensionClassInstancePtr, void> free_instance_func; /* this one is mandatory */
	public delegate* unmanaged[Cdecl]<void*, byte*, delegate* unmanaged[Cdecl]<ExtensionClassInstancePtr, TypePtr*, TypePtr, void>> get_virtual_func;
...
public unsafe struct ExtensionClassLibraryPtr {
	void* ptr;
	public static implicit operator void*(ExtensionClassLibraryPtr ptr) => ptr.ptr;
	public static implicit operator ExtensionClassLibraryPtr(void* ptr) => new ExtensionClassLibraryPtr() { ptr = ptr };
}
...
public unsafe struct ExtensionClassMethodInfo {
	...
	public delegate* unmanaged[Cdecl]<void*, ExtensionClassInstancePtr, VariantPtr*, Int, void> call_func;
	public delegate* unmanaged[Cdecl]<void*, ExtensionClassInstancePtr, TypePtr*, TypePtr, void> ptrcall_func;
	public uint method_flags; /* ExtensionClassMethodFlags */
	public uint argument_count;
	public Bool has_return_value;
	public delegate* unmanaged[Cdecl]<void*, int, VariantType> get_argument_type_func;
	public delegate* unmanaged[Cdecl]<void*, int, PropertyInfo, void> get_argument_info_func; /* name and hint information for the argument can be omitted in release builds. Class name should always be present if it applies. */
	public delegate* unmanaged[Cdecl]<void*, int, ExtensionClassMethodArgumentMetadata> get_argument_metadata_func;
...
public unsafe struct ExtensionScriptInstanceDataPtr {
	void* ptr;
	public static implicit operator void*(ExtensionScriptInstanceDataPtr ptr) => ptr.ptr;
	public static implicit operator ExtensionScriptInstanceDataPtr(void* ptr) => new ExtensionScriptInstanceDataPtr() { ptr = ptr };
}
public unsafe struct ExtensionScriptLanguagePtr {
	void* ptr;
	public static implicit operator void*(ExtensionScriptLanguagePtr ptr) => ptr.ptr;
	public static implicit operator ExtensionScriptLanguagePtr(void* ptr) => new ExtensionScriptLanguagePtr() { ptr = ptr };
}

public unsafe struct ScriptInstancePtr {
	void* ptr;
	public static implicit operator void*(ScriptInstancePtr ptr) => ptr.ptr;
	public static implicit operator ScriptInstancePtr(void* ptr) => new ScriptInstancePtr() { ptr = ptr };
}
...
public unsafe struct ExtensionScriptInstanceInfo {
	...
	public delegate* unmanaged[Cdecl]<ExtensionScriptInstanceDataPtr, delegate* unmanaged[Cdecl]<StringNamePtr, VariantPtr, void*, void>, void*, void> get_property_state_func;
...
public unsafe struct Interface {
	...
	/* GODOT CORE */
	public unsafe delegate* unmanaged[Cdecl]<nint, void*> mem_alloc;
	public unsafe delegate* unmanaged[Cdecl]<void*, nint, void*> mem_realloc;
	public unsafe delegate* unmanaged[Cdecl]<void*, void> mem_free;

	public unsafe delegate* unmanaged[Cdecl]<byte*, byte*, byte*, int, void> print_error;
	...
	public unsafe delegate* unmanaged[Cdecl]<byte*, long> getNativeStructSize;

	/* GODOT VARIANT */

	/* variant general */
	public unsafe delegate* unmanaged[Cdecl]<VariantPtr, VariantPtr, void> variantNewCopy;
	public unsafe delegate* unmanaged[Cdecl]<VariantPtr, void> variantNewNil;
	public unsafe delegate* unmanaged[Cdecl]<VariantPtr, void> variantDestroy;
	...
	public unsafe delegate* unmanaged[Cdecl]<VariantPtr, StringPtr, void> variant_stringify;
	...
	public unsafe delegate* unmanaged[Cdecl]<VariantType, StringPtr, void> variant_get_type_name;
	...
	public unsafe delegate* unmanaged[Cdecl]<VariantType, VariantPtr, VariantPtr*, int, CallError*, void> variant_ruct;
	...
	public unsafe delegate* unmanaged[Cdecl]<VariantType, byte*, VariantPtr, void> variant_get_ant_value;
	...
	public unsafe delegate* unmanaged[Cdecl]<StringPtr, byte*, void> string_new_with_latin1_bytes;
	public unsafe delegate* unmanaged[Cdecl]<StringPtr, byte*, void> string_new_with_utf8_bytes;
	public unsafe delegate* unmanaged[Cdecl]<StringPtr, char*, void> string_new_with_utf16_bytes;
	public unsafe delegate* unmanaged[Cdecl]<StringPtr, int*, void> string_new_with_utf32_bytes;
	public unsafe delegate* unmanaged[Cdecl]<StringPtr, char*, void> string_new_with_wide_bytes; //not sure if char is the right size for w_char
	public unsafe delegate* unmanaged[Cdecl]<StringPtr, byte*, long, void> string_new_with_latin1_bytes_and_len;
	public unsafe delegate* unmanaged[Cdecl]<StringPtr, byte*, long, void> string_new_with_utf8_bytes_and_len;
	public unsafe delegate* unmanaged[Cdecl]<StringPtr, char*, long, void> string_new_with_utf16_bytes_and_len;
	public unsafe delegate* unmanaged[Cdecl]<StringPtr, int*, long, void> string_new_with_utf32_bytes_and_len;
	public unsafe delegate* unmanaged[Cdecl]<StringPtr, char*, long, void> string_new_with_wide_bytes_and_len; //not sure if char is the right size for w_char
	/* Information about the following functions:
	 * - The return value is the resulting encoded string length.
	 * - The length returned is in byteacters, not in bytes. It also does not include a trailing zero.
	 ...
	 * - Passing NULL in means only the length is computed  again, without including trailing zero .
	 * - argument is in byteacters, not bytes. It will be ignored if is NULL.
	 * - argument does not affect the return value, it's only to cap write length.
	 */
	public unsafe delegate* unmanaged[Cdecl]<StringPtr, byte*, long, long> string_to_latin1_bytes;
	public unsafe delegate* unmanaged[Cdecl]<StringPtr, byte*, long, long> string_to_utf8_bytes;
	public unsafe delegate* unmanaged[Cdecl]<StringPtr, char*, long, long> string_to_utf16_bytes;
	public unsafe delegate* unmanaged[Cdecl]<StringPtr, int*, long, long> string_to_utf32_bytes;
	public unsafe delegate* unmanaged[Cdecl]<StringPtr, char*, long, long> string_to_wide_bytes;
	public unsafe delegate* unmanaged[Cdecl]<StringPtr, long, int*> string_operator_index;
	public unsafe delegate* unmanaged[Cdecl]<StringPtr, long, int*> string_operator_index_;
	...
	public unsafe delegate* unmanaged[Cdecl]<TypePtr, long, StringPtr> packed_string_array_operator_index; // should be a PackedStringArray
	public unsafe delegate* unmanaged[Cdecl]<TypePtr, long, StringPtr> packed_string_array_operator_index_; // should be a PackedStringArray
	...
	public unsafe delegate* unmanaged[Cdecl]<ObjectPtr, void*, void*, InstanceBindingCallbacks*, void> object_set_instance_binding;
	public unsafe delegate* unmanaged[Cdecl]<ObjectPtr, void*, InstanceBindingCallbacks*, void*> object_get_instance_binding;
	...
	public unsafe delegate* unmanaged[Cdecl]<ObjectPtr, void*, ObjectPtr> object_cast_to;
	...
	/* CLASSDB */
	public unsafe delegate* unmanaged[Cdecl]<byte*, ObjectPtr> classdb_ruct_object; /* The passed class must be a built-in godot class, or an already-registered extension class. In both case, object_set_instance should be called to fully initialize the object. */
	public unsafe delegate* unmanaged[Cdecl]<byte*, byte*, long, MethodBindPtr> classdb_get_method_bind;
	public unsafe delegate* unmanaged[Cdecl]<byte*, void*> classdb_get_class_tag;
	...
	public unsafe delegate* unmanaged[Cdecl]<ExtensionClassLibraryPtr, StringPtr, void> get_library_path;
...
public unsafe struct Initialization {
	...
	public delegate* unmanaged[Cdecl]<void*, InitializationLevel, void> initialize;
	public delegate* unmanaged[Cdecl]<void*, InitializationLevel, void> deinitialize;
}
